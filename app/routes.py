...
@main_bp.route('/remove_card/<int:card_id>', methods=['POST'])  # Currently @app.route
@login_required
...
@main_bp.route('/update_prices', methods=['POST'])  # Currently @app.route
@login_required
def update_prices():
...
@main_bp.route('/api/collection_stats')
@login_required
